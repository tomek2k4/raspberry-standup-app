...
//##### OPERATION NOTES #####
//###########################
//- The window displays a coundown in days:hours:minutes:seconds until new year.
//Once new year is reached zero is displayed until midday on 1st January where the countdown starts to the next new year.
//- Pressing CTRL+T allows the countdown display and outputs to be tested.  Pressing mutliple times will get to a final 15 second countdown.
//- The following pins are set as outputs and normally low:
//	RPI_V2_GPIO_P1_03
//	RPI_V2_GPIO_P1_05
//	RPI_V2_GPIO_P1_07
//	RPI_V2_GPIO_P1_11
...
//	RPI_V2_GPIO_P1_21
//	RPI_V2_GPIO_P1_22
//When the final 10 seconds of the countdown occur (including during testing) they are turned on one by one (starting from P1_03) so they end
//up all on.  After 10 minutes they are turned back off. 
